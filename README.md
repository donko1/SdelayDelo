...
5. **Use frontend**. You can download official front-end part to use it. U can watch it by following url: [donko1/SdelayDelo_react](https://github.com/donko1/SdelayDelo_react)