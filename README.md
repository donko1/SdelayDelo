...
6. **Create notes for test**. You can easily create notes for testing using `python3 manage.py generate_notes`. Adter it you need to login with username testuser and password testpass123 to see notes
7. **Checking code with ruff**. Our project uses  [Ruff](https://github.com/astral-sh/ruff) for fast Python linting and code formatting. So, you can use our ruff.toml! That means that our code is clean, and you can easily check your new code, if you will write it!